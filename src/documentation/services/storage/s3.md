...
|Question                                                                |Answer                                                                  |
|:-----------------------------------------------------------------------|:-----------------------------------------------------------------------|
|**Name** (named remote)                                                 |a chosen value of the ==`Object storage name`== , like ==`store`==      |
|**Choose your S3 provider**                                             |==`Ceph`==                                                              |
|**Enter AWS credentials in the next step**                              |==`false`==                                                             |
|**AWS Access Key ID**                                                   |the value from the Zerops Storage access details ==`Access Key Id`==    |
|**AWS Secret Access Key**                                               |the value from the Zerops Storage access details ==`Secret Access Key`==|
|**Region to connect to**                                                |==`""`==                                                                |
|**Endpoint for S3 API**                                                 |the value from the Zerops Storage access details ==`Api Url`==          |
