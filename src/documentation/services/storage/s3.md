...
* How to manage object storage's buckets:
  ...
  * [create a default new one](/knowledge-base/how-to-do/using-object-storage-in-golang.html#creating-a-new-object-storage-bucket), get existing ACL, or update existing ACL from [Golang](/knowledge-base/how-to-do/using-object-storage-in-golang.html)
