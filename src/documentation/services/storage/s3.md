...
The unique generated **serviceId** (see [Storage access details](#from-local-environment)) of the created Zerops Object Storage Service instance is used as the canonical **ID** property above.
:::
<!-- markdownlint-enable DOCSMD004 -->
...
* How to manage object storage's buckets:
  * [create a default new one](/knowledge-base/how-to-do/using-object-storage-in-php.html#creating-a-new-object-storage-bucket), [get existing ACL](/knowledge-base/how-to-do/using-object-storage-in-php.html#getting-an-existed-object-storage-bucket-acl-setting), or [update existing ACL](/knowledge-base/how-to-do/using-object-storage-in-php.html#update-an-existed-object-storage-bucket-acl) from [PHP](/knowledge-base/how-to-do/using-object-storage-in-php.html)
  * [create a default new one](/knowledge-base/how-to-do/using-object-storage-in-nodejs.html#creating-a-new-object-storage-bucket), [get existing ACL](/knowledge-base/how-to-do/using-object-storage-in-nodejs.html#getting-an-existed-object-storage-bucket-acl-setting), or [update existing ACL](/knowledge-base/how-to-do/using-object-storage-in-php.html#update-an-existed-object-storage-bucket-acl) from [Node.js](/knowledge-base/how-to-do/using-object-storage-in-nodejs.html)
  * create a default new one, get existing ACL, or update existing ACL from [Golang](/knowledge-base/how-to-do/using-object-storage-in-golang.html)
...
* How to manage bucket's objects (with body or a file):
  ...
  * [put](/knowledge-base/how-to-do/using-object-storage-in-nodejs.html#adding-a-new-bucket-s-object-with-body-or-a-file) and [get](/knowledge-base/how-to-do/using-object-storage-in-nodejs.html#getting-an-existed-bucket-s-object-with-body-or-a-file) from [Node.js](/knowledge-base/how-to-do/using-object-storage-in-nodejs.html)
