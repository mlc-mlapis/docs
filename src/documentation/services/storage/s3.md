...
* How to manage object storage's buckets:
  ...
  * [create a default new one](/knowledge-base/how-to-do/using-object-storage-in-golang.html#creating-a-new-object-storage-bucket), [get existing ACL](/knowledge-base/how-to-do/using-object-storage-in-golang.html#getting-an-existing-object-storage-bucket-acl-setting), or update existing ACL from [Golang](/knowledge-base/how-to-do/using-object-storage-in-golang.html)
