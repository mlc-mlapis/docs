...
* But you can also have reasons to make activity logging by a different way, for example, using logging libraries like [winston](https://www.npmjs.com/package/winston), [bunyan](https://www.npmjs.com/package/bunyan), or [syslog-client](https://www.npmjs.com/package/syslog-client). These could be more suitable for your projects then. The reason may also be more flexible way how to set up facility numbers, severities, and other parameters.
